...
@Entity
@Table(name = "master_data", schema="vprp_master")
public class MasterData {
	...
	public MasterData(Long id, String mstName, String mstCode, String mstExtId, Long mstParentId, String mstType,
			String mstStatus, String mstDesc, String mstShortName, String mstAddlData, String createdBy, String updatedBy,
			Date createdDate, Date updateDate, Long revisionNumber, Integer stateId) {
		super();
		this.id = id;
	...
	public String getMstExtId() {
		return mstExtId;
	}

	public void setMstExtId(String mstExtId) {
		this.mstExtId = mstExtId;
	}
