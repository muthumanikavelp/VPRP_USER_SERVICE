...
@Entity
@Table(name = "shg_applications", schema = "vprp_transaction", uniqueConstraints = {
		@UniqueConstraint(columnNames = { "shg_id", "survey_year" }) })
public class ShgApplications {
	...
	@Column(name = "shg_id", columnDefinition = "clob")
	private Long shgId;
	...
	public ShgApplications(Long shgId, Long parentCBOId, Integer parentCBOType, Long stateId, Long districtId,
	...
	public ShgApplications(Long id, Long shgId, Long parentCBOId, Integer parentCBOType, Long stateId, Long districtId,
			Long blockId, Long panchayatId, Long villageId, Integer surveyYear, String applicationDataJson,
			Integer shgSurveyStatus, Long createdBy, Long updatedBy, Date createdDate, Date updateDate,
			Long revisionNumber) {
		super();
